...
\picframew{../media/mandelbrot_set}{Alternatives: Escape time fractals \qquad\qquad{\small\href{https://www.youtube.com/watch?v=PD2XgQOyCCk}{Animation @ YouTube}}}
...
\begin{frame}
\frametitle{Natural-looking computer simulations}
\begin{itemize}[<+->]
	...
	\item Often used in computer games, TV and film \href{https://youtu.be/52XlyMbxxh8?t=106}{(\alert{Star Trek II})}
